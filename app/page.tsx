...
<option value="Course/Education">Course/Education</option>
  ...
  <span className="text-red-500 mr-2 mt-1">→</span>Use open-ended questions that capture authentic customer language. (Yes/no questions don't reveal the insights needed for effective copy.)</li>
              <li className="text-black flex items-start">
  <span className="text-red-500 mr-2 mt-1">→</span>Send surveys with direct subject lines like "Can you help me with some quick questions?" - Or use your brand-moderated Facebook Group, Subreddit, etc. And always mention the time commitment upfront: "Takes 5-7 minutes."</li>
  <li className="text-black flex items-start">
  <span className="text-red-500 mr-2 mt-1">→</span>Maintain framing as helping you improve: "We're always working to better serve customers like you and improve our products/services based on real feedback."</li>
   <li className="text-black flex items-start">
  <span className="text-red-500 mr-2 mt-1">→</span>If needed, consider small incentives: discount codes, early access, exclusive content, etc.</li>
            </ul>
          </div>
